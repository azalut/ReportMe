...
<@layout.extends name="account/account-template.ftl">
    <@layout.put block="account-content">
        ...
        <a href="<@spring.url '/account/mygroups'/>" class="account-menu-option">Powrót do osiedli</a>
        <a href="<@spring.url '/account/delete/${group.name}'/>" class="account-menu-option">Usuń tę grupę</a>
    </@layout.put>
</@layout.extends>